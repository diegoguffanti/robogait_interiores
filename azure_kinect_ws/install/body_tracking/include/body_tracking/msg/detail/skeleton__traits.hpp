...
#ifndef BODY_TRACKING__MSG__DETAIL__SKELETON__TRAITS_HPP_
#define BODY_TRACKING__MSG__DETAIL__SKELETON__TRAITS_HPP_
...
template<>
inline const char * data_type<body_tracking::msg::Skeleton>()
{
  return "body_tracking::msg::Skeleton";
}

template<>
inline const char * name<body_tracking::msg::Skeleton>()
{
  return "body_tracking/msg/Skeleton";
}

template<>
struct has_fixed_size<body_tracking::msg::Skeleton>
  : std::integral_constant<bool, has_fixed_size<geometry_msgs::msg::Point32>::value> {};

template<>
struct has_bounded_size<body_tracking::msg::Skeleton>
  : std::integral_constant<bool, has_bounded_size<geometry_msgs::msg::Point32>::value> {};

template<>
struct is_message<body_tracking::msg::Skeleton>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // BODY_TRACKING__MSG__DETAIL__SKELETON__TRAITS_HPP_
