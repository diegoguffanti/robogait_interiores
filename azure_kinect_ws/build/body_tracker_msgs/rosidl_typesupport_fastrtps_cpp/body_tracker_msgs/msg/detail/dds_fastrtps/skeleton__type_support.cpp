...
#include "body_tracker_msgs/msg/detail/skeleton__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const body_tracker_msgs::msg::Skeleton & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.joint_position_head,
    cdr);
  // Member: joint_position_neck
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.joint_position_neck,
    cdr);
  // Member: joint_position_shoulder
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.joint_position_shoulder,
    cdr);
  // Member: joint_position_spine_top
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.joint_position_spine_top,
    cdr);
  // Member: joint_position_spine_mid
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.joint_position_spine_mid,
    cdr);
  ...
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.joint_position_left_shoulder,
    cdr);
  // Member: joint_position_left_elbow
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.joint_position_left_elbow,
    cdr);
  // Member: joint_position_left_hand
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.joint_position_left_hand,
    cdr);
  // Member: joint_position_right_shoulder
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.joint_position_right_shoulder,
    cdr);
  // Member: joint_position_right_elbow
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.joint_position_right_elbow,
    cdr);
  // Member: joint_position_right_hand
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.joint_position_right_hand,
    cdr);
  // Member: joint_position_right_hip
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.joint_position_right_hip,
    cdr);
  // Member: joint_position_right_knee
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.joint_position_right_knee,
    cdr);
  // Member: joint_position_right_ankle
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.joint_position_right_ankle,
    cdr);
  // Member: joint_position_left_hip
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.joint_position_left_hip,
    cdr);
  // Member: joint_position_left_knee
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.joint_position_left_knee,
    cdr);
  // Member: joint_position_left_ankle
  geometry_msgs::msg::typesupport_fastrtps_cpp::cdr_serialize(
    ros_message.joint_position_left_ankle,
    cdr);
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  body_tracker_msgs::msg::Skeleton & ros_message)
{
  // Member: body_id
  cdr >> ros_message.body_id;
...
{
  auto typed_message =
    static_cast<const body_tracker_msgs::msg::Skeleton *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<body_tracker_msgs::msg::Skeleton *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _Skeleton__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const body_tracker_msgs::msg::Skeleton *>(
...
{
  return max_serialized_size_Skeleton(full_bounded, 0);
}

static message_type_support_callbacks_t _Skeleton__callbacks = {
...
static rosidl_message_type_support_t _Skeleton__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_Skeleton__callbacks,
...
{
  return &body_tracker_msgs::msg::typesupport_fastrtps_cpp::_Skeleton__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, body_tracker_msgs, msg, Skeleton)() {
  return &body_tracker_msgs::msg::typesupport_fastrtps_cpp::_Skeleton__handle;
}
