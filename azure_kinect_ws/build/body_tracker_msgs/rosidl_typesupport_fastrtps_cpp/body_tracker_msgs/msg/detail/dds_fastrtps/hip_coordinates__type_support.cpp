...
#include "body_tracker_msgs/msg/detail/hip_coordinates__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const body_tracker_msgs::msg::HipCoordinates *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<body_tracker_msgs::msg::HipCoordinates *>(
    untyped_ros_message);
...
{
  return &body_tracker_msgs::msg::typesupport_fastrtps_cpp::_HipCoordinates__handle;
}
