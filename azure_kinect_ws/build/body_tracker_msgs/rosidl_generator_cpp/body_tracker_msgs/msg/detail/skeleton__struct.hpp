...
#ifndef BODY_TRACKER_MSGS__MSG__DETAIL__SKELETON__STRUCT_HPP_
#define BODY_TRACKER_MSGS__MSG__DETAIL__SKELETON__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__body_tracker_msgs__msg__Skeleton __attribute__((deprecated))
#else
# define DEPRECATED__body_tracker_msgs__msg__Skeleton __declspec(deprecated)
#endif
...
struct Skeleton_
{
  ...
  // pointer types
  using RawPtr =
    body_tracker_msgs::msg::Skeleton_<ContainerAllocator> *;
  using ConstRawPtr =
    const body_tracker_msgs::msg::Skeleton_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<body_tracker_msgs::msg::Skeleton_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<body_tracker_msgs::msg::Skeleton_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      body_tracker_msgs::msg::Skeleton_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<body_tracker_msgs::msg::Skeleton_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<body_tracker_msgs::msg::Skeleton_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<body_tracker_msgs::msg::Skeleton_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<body_tracker_msgs::msg::Skeleton_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__body_tracker_msgs__msg__Skeleton
    std::shared_ptr<body_tracker_msgs::msg::Skeleton_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__body_tracker_msgs__msg__Skeleton
    std::shared_ptr<body_tracker_msgs::msg::Skeleton_<ContainerAllocator> const>
...
using Skeleton =
  body_tracker_msgs::msg::Skeleton_<std::allocator<void>>;
...
#endif  // BODY_TRACKER_MSGS__MSG__DETAIL__SKELETON__STRUCT_HPP_
