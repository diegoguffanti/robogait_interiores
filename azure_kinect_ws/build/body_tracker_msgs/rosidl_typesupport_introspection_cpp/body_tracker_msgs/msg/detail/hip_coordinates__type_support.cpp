...
{
  new (message_memory) body_tracker_msgs::msg::HipCoordinates(_init);
}

void HipCoordinates_fini_function(void * message_memory)
{
  auto typed_message = static_cast<body_tracker_msgs::msg::HipCoordinates *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember HipCoordinates_message_member_array[3] = {
  {
    ...
    offsetof(body_tracker_msgs::msg::HipCoordinates, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(body_tracker_msgs::msg::HipCoordinates, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(body_tracker_msgs::msg::HipCoordinates, z),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers HipCoordinates_message_members = {
  ...
  3,  // number of fields
  sizeof(body_tracker_msgs::msg::HipCoordinates),
...
get_message_type_support_handle<body_tracker_msgs::msg::HipCoordinates>()
{
  return &::body_tracker_msgs::msg::rosidl_typesupport_introspection_cpp::HipCoordinates_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, body_tracker_msgs, msg, HipCoordinates)() {
  return &::body_tracker_msgs::msg::rosidl_typesupport_introspection_cpp::HipCoordinates_message_type_support_handle;
}
