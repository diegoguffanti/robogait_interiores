...
#include "body_tracker_msgs/msg/detail/skeleton__rosidl_typesupport_fastrtps_c.h"
...
using _Skeleton__ros_msg_type = body_tracker_msgs__msg__Skeleton;
...
size_t get_serialized_size_body_tracker_msgs__msg__Skeleton(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Skeleton__ros_msg_type * ros_message = static_cast<const _Skeleton__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _Skeleton__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_body_tracker_msgs__msg__Skeleton(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_body_tracker_msgs
size_t max_serialized_size_body_tracker_msgs__msg__Skeleton(
  bool & full_bounded,
  size_t current_alignment)
{
  size_t initial_alignment = current_alignment;
...
{
  return max_serialized_size_body_tracker_msgs__msg__Skeleton(
    full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, body_tracker_msgs, msg, Skeleton)() {
