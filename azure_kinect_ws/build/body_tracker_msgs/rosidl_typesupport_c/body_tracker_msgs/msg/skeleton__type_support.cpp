...
static const _Skeleton_type_support_symbol_names_t _Skeleton_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, body_tracker_msgs, msg, Skeleton)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, body_tracker_msgs, msg, Skeleton)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, body_tracker_msgs, msg, Skeleton)() {
  return &::body_tracker_msgs::msg::rosidl_typesupport_c::Skeleton_message_type_support_handle;
}
