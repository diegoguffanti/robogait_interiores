...
static const _HipCoordinates_type_support_symbol_names_t _HipCoordinates_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, body_tracker_msgs, msg, HipCoordinates)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, body_tracker_msgs, msg, HipCoordinates)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, body_tracker_msgs, msg, HipCoordinates)() {
  return &::body_tracker_msgs::msg::rosidl_typesupport_c::HipCoordinates_message_type_support_handle;
}
