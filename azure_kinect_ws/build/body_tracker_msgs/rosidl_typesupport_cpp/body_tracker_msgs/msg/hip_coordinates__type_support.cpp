...
static const _HipCoordinates_type_support_symbol_names_t _HipCoordinates_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, body_tracker_msgs, msg, HipCoordinates)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, body_tracker_msgs, msg, HipCoordinates)),
  }
};
...
{
  return &::body_tracker_msgs::msg::rosidl_typesupport_cpp::HipCoordinates_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, body_tracker_msgs, msg, HipCoordinates)() {
  return get_message_type_support_handle<body_tracker_msgs::msg::HipCoordinates>();
}
