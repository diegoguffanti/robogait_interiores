...
bool
body_tracker_msgs__msg__Skeleton__init(body_tracker_msgs__msg__Skeleton * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!geometry_msgs__msg__Point32__init(&msg->joint_position_head)) {
    body_tracker_msgs__msg__Skeleton__fini(msg);
    return false;
  }
  // joint_position_neck
...
void
body_tracker_msgs__msg__Skeleton__fini(body_tracker_msgs__msg__Skeleton * msg)
{
  if (!msg) {
    return;
  }
...
body_tracker_msgs__msg__Skeleton *
body_tracker_msgs__msg__Skeleton__create()
{
  body_tracker_msgs__msg__Skeleton * msg = (body_tracker_msgs__msg__Skeleton *)malloc(sizeof(body_tracker_msgs__msg__Skeleton));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(body_tracker_msgs__msg__Skeleton));
  bool success = body_tracker_msgs__msg__Skeleton__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
void
body_tracker_msgs__msg__Skeleton__destroy(body_tracker_msgs__msg__Skeleton * msg)
{
  if (msg) {
    body_tracker_msgs__msg__Skeleton__fini(msg);
  }
...
bool
body_tracker_msgs__msg__Skeleton__Sequence__init(body_tracker_msgs__msg__Skeleton__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  body_tracker_msgs__msg__Skeleton * data = NULL;
  if (size) {
    data = (body_tracker_msgs__msg__Skeleton *)calloc(size, sizeof(body_tracker_msgs__msg__Skeleton));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = body_tracker_msgs__msg__Skeleton__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        body_tracker_msgs__msg__Skeleton__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
void
body_tracker_msgs__msg__Skeleton__Sequence__fini(body_tracker_msgs__msg__Skeleton__Sequence * array)
{
  if (!array) {
    return;
  }
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      body_tracker_msgs__msg__Skeleton__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
body_tracker_msgs__msg__Skeleton__Sequence *
body_tracker_msgs__msg__Skeleton__Sequence__create(size_t size)
{
  body_tracker_msgs__msg__Skeleton__Sequence * array = (body_tracker_msgs__msg__Skeleton__Sequence *)malloc(sizeof(body_tracker_msgs__msg__Skeleton__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = body_tracker_msgs__msg__Skeleton__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
void
body_tracker_msgs__msg__Skeleton__Sequence__destroy(body_tracker_msgs__msg__Skeleton__Sequence * array)
{
  if (array) {
    body_tracker_msgs__msg__Skeleton__Sequence__fini(array);
  }
  free(array);
}
