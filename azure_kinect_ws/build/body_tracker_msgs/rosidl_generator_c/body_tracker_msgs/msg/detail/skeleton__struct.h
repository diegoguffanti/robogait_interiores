...
#ifndef BODY_TRACKER_MSGS__MSG__DETAIL__SKELETON__STRUCT_H_
#define BODY_TRACKER_MSGS__MSG__DETAIL__SKELETON__STRUCT_H_
...
// Struct defined in msg/Skeleton in the package body_tracker_msgs.
typedef struct body_tracker_msgs__msg__Skeleton
{
  int32_t body_id;
  double tiempo;
...
// Struct for a sequence of body_tracker_msgs__msg__Skeleton.
typedef struct body_tracker_msgs__msg__Skeleton__Sequence
{
  body_tracker_msgs__msg__Skeleton * data;
...
#endif  // BODY_TRACKER_MSGS__MSG__DETAIL__SKELETON__STRUCT_H_
