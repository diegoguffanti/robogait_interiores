...
static const _Skeleton_type_support_symbol_names_t _Skeleton_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, body_tracking, msg, Skeleton)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, body_tracking, msg, Skeleton)),
  }
};
...
{
  return &::body_tracking::msg::rosidl_typesupport_cpp::Skeleton_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, body_tracking, msg, Skeleton)() {
  return get_message_type_support_handle<body_tracking::msg::Skeleton>();
}
