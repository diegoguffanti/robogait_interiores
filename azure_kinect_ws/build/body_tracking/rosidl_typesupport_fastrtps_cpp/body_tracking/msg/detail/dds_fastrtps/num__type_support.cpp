...
#include "body_tracking/msg/detail/num__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
  auto typed_message =
    static_cast<const body_tracking::msg::Num *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<body_tracking::msg::Num *>(
    untyped_ros_message);
...
{
  return &body_tracking::msg::typesupport_fastrtps_cpp::_Num__handle;
}
