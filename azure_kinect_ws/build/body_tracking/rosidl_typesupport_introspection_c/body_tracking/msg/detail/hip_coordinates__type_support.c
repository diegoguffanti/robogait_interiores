...
#include <stddef.h>
#include "body_tracking/msg/detail/hip_coordinates__rosidl_typesupport_introspection_c.h"
  ...
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  ...
  (void) _init;
  body_tracking__msg__HipCoordinates__init(message_memory);
}

void HipCoordinates__rosidl_typesupport_introspection_c__HipCoordinates_fini_function(void * message_memory)
{
  body_tracking__msg__HipCoordinates__fini(message_memory);
}
...
static rosidl_typesupport_introspection_c__MessageMember HipCoordinates__rosidl_typesupport_introspection_c__HipCoordinates_message_member_array[3] = {
  {
    ...
    offsetof(body_tracking__msg__HipCoordinates, x),  // bytes offset in struct
    NULL,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(body_tracking__msg__HipCoordinates, y),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(body_tracking__msg__HipCoordinates, z),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
...
static const rosidl_typesupport_introspection_c__MessageMembers HipCoordinates__rosidl_typesupport_introspection_c__HipCoordinates_message_members = {
  ...
  3,  // number of fields
  sizeof(body_tracking__msg__HipCoordinates),
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, body_tracking, msg, HipCoordinates)() {
