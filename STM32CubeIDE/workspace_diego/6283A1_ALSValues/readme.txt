/**
  @page 6283A1_ALSValues example based on X-NUCLEO-6283A1 expansion board and STM32 Nucleo boards
  
  @verbatim
  ******************************************************************************
  * @file    readme.txt
  * @author  IMG SW Application Team
  * @brief   This example shows how to retrieve light counts
  *          from vd6283tx light sensor embedded on X-NUCLEO-62863A1 expansion board.
  *          The user can adjust gain, exposure time and inter-measurement using the keypad.
...
This example shows how to use X-NUCLEO-6283A1 expansion board and a STM32 Nucleo board to read light counts 
...
The user can adjust gain, exposure time and inter-measurement using the keypad.
This example performs measurements in continuous mode and wait for interrupts from the device before printing the data, 
so make sure the corresponding EXTI line is configured correctly.
