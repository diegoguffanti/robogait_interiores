...
float rx_buf[6], tx_buf[2]; //Buffers comunicacion
...
private:
	...
	{ //Bucle principal
		...
		while (1)
		{
			...
			odom_msg.twist.twist.linear.y = rx_buf[4]; //Velocidad y actual
			...
			odom_msg.twist.twist.angular.z = rx_buf[5]; //Rotacion z actual
			...
			imu_msg.orientation.w=rx_buf[6];
			
			imu_msg.angular_velocity.x=0;
			imu_msg.angular_velocity.y=0;
			imu_msg.angular_velocity.z=rx_buf[7];
			
			
			imu_msg.linear_acceleration.x=rx_buf[8];
