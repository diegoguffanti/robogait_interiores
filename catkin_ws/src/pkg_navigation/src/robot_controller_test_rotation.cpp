...
Subscription<std_msgs::msg::Float32>::SharedPtr subscription_angle_test;
...
public:
	generic() : Node("robot_controller")
		...
		subscription_angle_test = this->create_subscription<std_msgs::msg::Float32>("angle",10, std::bind(&generic::callback_angle_test, this, _1));
...
private:
	    ...
	    void callback_angle_test(const std_msgs::msg::Float32::SharedPtr msg) 
	    {

	      angle_goal=msg->data;
	      cout << angle_goal<< endl;
	    ...
	    void callback_keyboard(const geometry_msgs::msg::Twist::SharedPtr msg) 
	    {
	      ...
	      cmd_keyboard_msg.linear.x=msg->linear.x;
	    ...
	    void loop()
	    {
	      //while (1)
	      //{
		      //md_velrobot_msg.linear.x = cmd_keyboard_msg.linear.x;
		      //cmd_velrobot_msg.angular.z = cmd_keyboard_msg.angular.z;
		      
		      tf2::Quaternion q_goal;
   		      q_goal.setRPY( 0, 0, angle_goal*(3.14159/180)); 
